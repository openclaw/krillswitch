...
KrillSwitch is developed at [openclaw/krillswitch](https://github.com/openclaw/krillswitch). The root changelog records shipped behavior. Application releases use `vX.Y.Z` tags. Core and React SDK releases use lockstep `sdk-vX.Y.Z` tags and npm trusted publishing.
